...
The [architecture](architecture.md), [shared UI design](shared-ui.md), and
[platform adapters](platform-adapters.md) already specify these boundaries.
...
The [offscreen benchmark](gpu-raster-benchmarks.md) and
...
2. **Pencil estimates need a correction mechanism.**
   ...
   [feedback design](instant-stroke-feedback.md) acknowledges this future work.
