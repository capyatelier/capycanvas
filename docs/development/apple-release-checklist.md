...
Physical iPad retesting is still required to close these visible stalls. Its
...
Physical large-photo warm URL delivery now passes. Reported fast-stroke and
repeated mid-zoom stalls block navigation/painting acceptance; diagnosis is in
`artifacts/apple-photo-lag-v1/`. Local save/reopen remains unconfirmed.
