...
macOS/Windows tablet testing. Windows receives the flush bars and tile gaps
from Rust but still paints the earlier 1px in-bar inset and 34px switcher/menu
tracks until its host adopts the rules above.
