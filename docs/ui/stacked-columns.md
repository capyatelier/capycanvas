...
On GTK, dropping a panel, toolbar, tab group or column in the menu/title bar
...
Dropping into a GTK panel group's body prepends the incoming tabs and selects
