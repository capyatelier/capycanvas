...
| Selected workspace and title-bar tool | Accent at 28% over the panel body, opaque | `#4c8fd5` | Stays visible on the light title-bar well |
...
| Accent, selection, focus, links, checked controls, drop indicators | Web/Android `#3584e4`; GTK native accent (drop hint currently separate blue) | Same | Do not tint; panel and toolbar selection is accent at 28% in dark and `#c1d8f0`, a lighter `#4c8fd5`, in light |
