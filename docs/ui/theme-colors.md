...
| Accent, selection, focus, links, checked controls, drop indicators | Web/Android `#3584e4`; GTK native accent (drop hint currently separate blue) | Same | Do not tint; panel and toolbar selection is accent at 28% in dark; in light it is the title-bar selection hue and saturation at 85% lightness (`#c1d8f0` from `#3584e4`) |
