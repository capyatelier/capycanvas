...
Date: 2026-09-23. Status: Core implementation complete on GTK, Web, Android, macOS, iPadOS and Windows.
...
GTK, Web, Android, macOS, iPadOS and Windows share the documented Select drawer.
Shared Rust owns behavior, validation, command availability, settings,
