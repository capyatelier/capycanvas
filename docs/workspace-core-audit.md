...
| Toolbar/menu/panel definitions | GTK and JS separately enumerated tools/menus; JS repeated panel names and six-tile count | Implemented: shared typed `UiCatalog`, `TOOLBAR_CONTROLS` and `MENUS`; allocator derives tile count from the catalog |
