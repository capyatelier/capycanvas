...
right. [Numeric controls](../ui/numeric-controls.md) use a trailing stepper for small
...
See [Numeric controls](../ui/numeric-controls.md) for the current cross-platform design.
