...
[Zen modes](../ui/shared-ui.md#window-chrome-and-zen-mode).
...
Current setup and test commands are maintained in the [Linux guide](../development/linux.md),
[web guide](../development/web.md) and [testing guide](../development/testing.md).
The earlier combined setup and control walkthrough have been removed because
they repeated those instructions and described superseded workspace behavior.
