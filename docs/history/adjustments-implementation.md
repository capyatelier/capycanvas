...
constructors; see [runtime filters](../reference/runtime-filters.md) for the loading contract
...
2. GTK, web and Android Filters, Properties and Stats for nerds panels. Filters
   ...
   actions. GTK, web and Android use categorized preview rows with search.
