...
Use the [Android development guide](../development/android.md) for SDK versions,
launcher setup and build commands. The earlier statement that documents were
in-memory only was superseded by the native file workflow recorded in
...
trailing stepper. See [numeric controls](../ui/numeric-controls.md). Category/detail panes adapt to list/page
