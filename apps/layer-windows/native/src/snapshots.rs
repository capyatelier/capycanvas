...
pub(crate) struct WindowsMetadata {
    ...
    pub windows_recovery: Option<Value>,
    pub windows_tabs: Option<Value>,
    pub windows_palettes: Option<Value>,
    pub windows_glass: Value,
    pub windows_tab_styles: serde_json::Map<String, Value>,
...
mod tests {
    ...
    fn metadata() -> WindowsMetadata {
        WindowsMetadata {
            ...
            windows_tabs: None,
            windows_palettes: None,
            windows_glass: Value::Null,
            windows_tab_styles: Default::default(),
