...
namespace CapyUi {
inline winrt::Microsoft::UI::Xaml::Media::Imaging::WriteableBitmap checkerBitmap(double logical,double scale,winrt::Windows::UI::Color light,winrt::Windows::UI::Color dark,double cell=5){
    ...
    for(int y=0;y<size;y++)for(int x=0;x<size;x++){
        ...
        double dx=std::fmod((x+.5)/scale,2*cell)-cell,dy=std::fmod((y+.5)/scale,2*cell)-cell;
