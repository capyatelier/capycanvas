...
final class CanvasView: UIView {
    ...
    override func didMoveToWindow() {
        ...
        sceneGeometry = nil
        if let window {
            // Native menus are presented beside their source view, so a source-
            // only trait override cannot improve their material. This affects
            // our editor window, never the user's system accessibility setting.
