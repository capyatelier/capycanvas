...
const process = Gio.Subprocess.new([
    'cargo', 'test', '--release', '-p', 'layer-linux', workspaceColumns ? 'native_collapsed_column_input' : workspaceWindow ? 'native_window_drag_input' : workspaceDrawer ? 'native_column_drawer_drag_input' : workspaceCursor ? 'native_divider_cursor_input' : workspaceClicks ? 'native_floating_click_input' : workspaceDrag ? 'native_toolbar_drag_input' : 'native_compositor_input',
...
GLib.timeout_add(GLib.PRIORITY_DEFAULT, 100, () => {
    ...
    if (workspaceClicks || workspaceCursor || workspaceDrawer || workspaceWindow || workspaceColumns) {
