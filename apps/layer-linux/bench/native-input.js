...
const columnGroups = ARGV.includes('--column-groups');
...
const workspaceMotion = workspaceEdges || colorPanel || columnGroups || ARGV.includes('--workspace-motion') || workspaceWeb || workspaceResize;
