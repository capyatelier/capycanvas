...
export function fingerprintAssets(directory) {
  ...
  for (const path of ["export-controls.js", "histogram.js","document-color.js","image-import.js"]) documents = replaceRequired(documents, `from './${path}'`, `from "./${names[path]}"`);
  ...
  for (const path of modules.slice(0, -1).filter(path => path !== "workspace-switcher.js" && path !== "color-controls.js" && path !== "export-controls.js" && path !== "histogram.js" && path !== "document-color.js" && path !== "image-import.js"))
...
export function packageWeb() {
  ...
  try {
    ...
    for (const path of ["app.js", "raster-worker-client.js", "raster-worker.js", "workspace-worker.js", "workspace-store.js", "workspace-switcher.js", "workspace-manager.js", "system-status.js","header.js", "color-controls.js","export-controls.js","histogram.js","document-color.js","image-import.js", "editor-panels.js", "workspace-chrome.js", "documents.js", "preferences.js", "gpu.js", "customization.js", "numeric.js", "layers.js", "effects.js", "tooltips.js", "style.css"])
