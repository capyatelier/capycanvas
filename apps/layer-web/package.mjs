...
export function fingerprintAssets(directory) {
  ...
  const modules = ["preferences.js", "gpu.js", "customization.js", "numeric.js", "layers.js", "pkg/layer_web.js", "app.js"];
...
export function packageWeb() {
  ...
  try {
    ...
    for (const path of ["app.js", "preferences.js", "gpu.js", "customization.js", "numeric.js", "layers.js", "style.css"])
