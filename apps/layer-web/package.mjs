...
export function fingerprintAssets(directory) {
  ...
  const modules = ["workspace-store.js","workspace-switcher.js","workspace-manager.js","system-status.js","header.js","color-controls.js","export-controls.js","editor-panels.js","workspace-chrome.js","documents.js","preferences.js", "gpu.js", "customization.js", "numeric.js", "layers.js", "effects.js", "tooltips.js", "pkg/layer_web.js", "raster-worker-client.js", "app.js"];
  ...
  publish("documents.js", replaceRequired(read(join(directory, "documents.js")), "from './export-controls.js'", `from "./${names["export-controls.js"]}"`));
  ...
  for (const path of modules.slice(0, -1).filter(path => path !== "workspace-switcher.js" && path !== "color-controls.js" && path !== "export-controls.js"))
...
export function packageWeb() {
  ...
  try {
    ...
    for (const path of ["app.js", "raster-worker-client.js", "raster-worker.js", "workspace-worker.js", "workspace-store.js", "workspace-switcher.js", "workspace-manager.js", "system-status.js","header.js", "color-controls.js","export-controls.js", "editor-panels.js", "workspace-chrome.js", "documents.js", "preferences.js", "gpu.js", "customization.js", "numeric.js", "layers.js", "effects.js", "tooltips.js", "style.css"])
