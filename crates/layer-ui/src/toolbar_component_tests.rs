...
fn toolbar_component_defaults_round_trip_on_supported_hosts() {
    for (preset, platform) in WorkspacePreset::ALL.into_iter().flat_map(|p| [Platform::Gtk, Platform::Web, Platform::Android, Platform::Windows, Platform::Mac, Platform::Ios].map(|platform| (p, platform))) {
