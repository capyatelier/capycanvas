...
impl CommandId {
    pub fn shortcut_id(self) -> String {
        match self {
            Self::SearchCommands => "command.SearchCommands",
            Self::DrawingBrush => "command.DrawingBrush",
            Self::Sculpt => "command.Sculpt",
            Self::SdrRendition => "command.SdrRendition",
            Self::PreviewSdr => "command.PreviewSdr",
            Self::SoftProofSetup => "command.SoftProofSetup",
            Self::SoftProof => "command.SoftProof",
            Self::GamutWarning => "command.GamutWarning",
            Self::Histogram => "command.Histogram",
            Self::ImportImage => "command.ImportImage",
            Self::PasteImage => "command.PasteImage",
            Self::DocumentProperties => "command.DocumentProperties",
            Self::AssignProfile => "command.AssignProfile",
            Self::ConvertColorSpace => "command.ConvertColorSpace",
            Self::ChangeBitDepth => "command.ChangeBitDepth",
            Self::RepairSourceProfile => "command.RepairSourceProfile",
            Self::RasterizeSource => "command.RasterizeSource",
            ...
            Self::ExportDocument => "command.ExportDocument",
            Self::CloseDocument => "command.CloseDocument",
            Self::Pen => "command.Pen",
            Self::Pencil => "command.Pencil",
            Self::Brush => "command.Brush",
            Self::Eraser => "command.Eraser",
            Self::Airbrush => "command.Airbrush",
            Self::Decoration => "command.Decoration",
            Self::Blend => "command.Blend",
            Self::Liquify => "command.Liquify",
            Self::Lasso => "command.Lasso",
            Self::Select => "command.Select",
            Self::RectangleSelect => "command.RectangleSelect",
            Self::EllipseSelect => "command.EllipseSelect",
            Self::PolygonSelect => "command.PolygonSelect",
            Self::ColorSelect => "command.ColorSelect",
            Self::SelectionBrush => "command.SelectionBrush",
            Self::TonalSelect => "command.TonalSelect",
            Self::TonalDetails => "command.TonalDetails",
            Self::ApplyTonalSelection => "command.ApplyTonalSelection",
            Self::CancelTonalSelection => "command.CancelTonalSelection",
            Self::TonalNewBand => "command.TonalNewBand",
            Self::TonalRemoveBand => "command.TonalRemoveBand",
            Self::TonalSaveBand => "command.TonalSaveBand",
            Self::TonalInvert => "command.TonalInvert",
            Self::TonalLowerOpen => "command.TonalLowerOpen",
            Self::TonalUpperOpen => "command.TonalUpperOpen",
            Self::TonalLinkFalloff => "command.TonalLinkFalloff",
            Self::QuickMask => "command.QuickMask",
            Self::ReturnToArtwork => "command.ReturnToArtwork",
            Self::NewSelectionLayer => "command.NewSelectionLayer",
            Self::SaveSelectionLayer => "command.SaveSelectionLayer",
            Self::Reselect => "command.Reselect",
            Self::SelectionOutline => "command.SelectionOutline",
            Self::MaskOverlay => "command.MaskOverlay",
            Self::MaskOverlayProtected => "command.MaskOverlayProtected",
            Self::ResetMaskColors => "command.ResetMaskColors",
            Self::SwapMaskColors => "command.SwapMaskColors",
            Self::FillSelectionMask => "command.FillSelectionMask",
            Self::ClearSelectionMask => "command.ClearSelectionMask",
            Self::SelectionBrushPressure => "command.SelectionBrushPressure",
            Self::SelectionNew => "command.SelectionNew",
            Self::SelectionAdd => "command.SelectionAdd",
            Self::SelectionSubtract => "command.SelectionSubtract",
            Self::SelectionIntersect => "command.SelectionIntersect",
            Self::SelectionAntialias => "command.SelectionAntialias",
            Self::SelectionConstrainAngles => "command.SelectionConstrainAngles",
            Self::SelectionFixedRatio => "command.SelectionFixedRatio",
            Self::SelectionFixedSize => "command.SelectionFixedSize",
            Self::SelectionFromCenter => "command.SelectionFromCenter",
            Self::CompleteSelection => "command.CompleteSelection",
            Self::CancelSelection => "command.CancelSelection",
            Self::SelectionVisible => "command.SelectionVisible",
            Self::SelectionEditing => "command.SelectionEditing",
            Self::SelectionReference => "command.SelectionReference",
            Self::Move => "command.Move",
            Self::ScaleRotate => "command.ScaleRotate",
            Self::ApplyTransform => "command.ApplyTransform",
            Self::CancelTransform => "command.CancelTransform",
            Self::TransformAspect => "command.TransformAspect",
            Self::PlacementOriginalSize => "command.PlacementOriginalSize",
            Self::Hand => "command.Hand",
            Self::Eyedropper => "command.Eyedropper",
            Self::Gradient => "command.Gradient",
            Self::Figure => "command.Figure",
            Self::Ruler => "command.Ruler",
            Self::ShowRulers => "command.ShowRulers",
            Self::SnapRulers => "command.SnapRulers",
            Self::DeleteRuler => "command.DeleteRuler",
            Self::AutoSelect => "command.AutoSelect",
            Self::Fill => "command.Fill",
            Self::Undo => "command.Undo",
            Self::Redo => "command.Redo",
            Self::ClearLayer => "command.ClearLayer",
            Self::FillSelection => "command.FillSelection",
            Self::SelectAll => "command.SelectAll",
            Self::Deselect => "command.Deselect",
            Self::InvertSelection => "command.InvertSelection",
            Self::UndoWorkspace => "command.UndoWorkspace",
            Self::RedoWorkspace => "command.RedoWorkspace",
            Self::NewToolbar => "command.NewToolbar",
            Self::ManageToolbars => "command.ManageToolbars",
            Self::CustomizeWorkspaceUi => "command.CustomizeWorkspaceUi",
            Self::FitCanvas => "command.FitCanvas",
            Self::ZoomIn => "command.ZoomIn",
            Self::ZoomOut => "command.ZoomOut",
            Self::RotateLeft => "command.RotateLeft",
            Self::RotateRight => "command.RotateRight",
            Self::FlipHorizontal => "command.FlipHorizontal",
            Self::FlipVertical => "command.FlipVertical",
            Self::Settings => "command.Settings",
            Self::ToggleTheme => "command.ToggleTheme",
            Self::AddLayer => "command.AddLayer",
            Self::DeleteLayer => "command.DeleteLayer",
            Self::RaiseLayer => "command.RaiseLayer",
            Self::LowerLayer => "command.LowerLayer",
            Self::ResetLayout => "command.ResetLayout",
            Self::ZenMode => "command.ZenMode",
            Self::Fullscreen => "command.Fullscreen",
            Self::NewWindow => "command.NewWindow",
            Self::KeyboardShortcuts => "command.KeyboardShortcuts",
            Self::About => "command.About",
            ...
            Self::MaskSelection => "command.MaskSelection",
        }.into()
    }
}
