...
pub use color::{
    ...
    ColorSwatchView, ColorWheelGeometry, ColorWheelPart, hue_color, render_color_field, render_hls_field, render_okhsv_disc, render_hsv_field, render_hue_guide,
};
...
impl CommandId {
    pub fn available_on(self, platform: Platform) -> bool {
        match self {
            ...
            Self::AssignProfile | Self::ConvertColorSpace | Self::ChangeBitDepth => matches!(platform, Platform::Gtk | Platform::Web | Platform::Android),
