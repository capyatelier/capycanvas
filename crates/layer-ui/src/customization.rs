    ...
    let (label, description, icon) = match control {
        ToolbarControl::Command { command } => (
            ...
            match command {
                ...
                CommandId::NewDocument => "Create a new drawing",
                CommandId::OpenDocument => "Open an editable project",
                CommandId::SaveDocument => "Save the editable project",
                CommandId::SaveDocumentAs => "Save the editable project to another file",
